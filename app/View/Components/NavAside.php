...
class NavAside extends Component
{
    ...
    public $sideNavRiwayatPenilaian;
    public $sideNavKepalaSekolah;
    public $sideNavPerhitungan;
    public $sideNavPerankingan;
    ...
    public function __construct()
    {
        ...
        $this->sideNavPerankingan = [
            'Perankingan' => [
                ...
                'permission' => 'perankingan',
            ]
        ];

        $this->sideNavKelolaAkun = [
            'Kelola Akun' => [
                'url' => 'kelola-akun',
                'viewBox' => '0 0 24 24',
                'paths' => [
    ...
    {
        return view('components.organism.nav-aside', [
            'sideNavDashboard' => $this->sideNavDashboard,
            'sideNavData' => $this->sideNavData,
            'sideNavPenilaian' => $this->sideNavPenilaian,
            'sideNavRiwayatPenilaian' => $this->sideNavRiwayatPenilaian,
            'sideNavKepalaSekolah' => $this->sideNavKepalaSekolah,
            'sideNavPerhitungan' => $this->sideNavPerhitungan,
            'sideNavPerankingan' => $this->sideNavPerankingan,
            'sideNavKelolaAkun' => $this->sideNavKelolaAkun,
        ]);
    }
}