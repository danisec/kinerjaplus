    ...
    public function totalBobotKriteria($uniqueAlternatifPenilaianByTahunAjaran, $kriteria, $bobotPrioritasSubkriteria, $bobotAlternatif)
    {
        ...
        foreach ($uniqueAlternatifPenilaianByTahunAjaran as $alternatifItem) {
            ...
            foreach ($kriteria as $kriteriaItem) {
                ...
                $bobotPrioritasAlternatifItem = $bobotAlternatif->where('kode_kriteria', $kriteriaItem->kode_kriteria)->where('kode_alternatif', $alternatifItem->alternatifKedua->kode_alternatif)->first();
            ...
            $totalBobotKriteria[$alternatifItem->alternatifKedua->kode_alternatif] = $total;
            $totalBobotKriteria[$alternatifItem->alternatifKedua->kode_alternatif] = substr($total, 0, 6);
        }
