<x-app-layout title="{{ $title = '405' }}">

    <section class="bg-white">
        <div class="container mx-auto flex min-h-screen items-center justify-center">
            <div>
                <p class="text-sm font-medium text-blue-600">405 Method Not Allowed</p>
                <h1 class="mt-3 text-2xl font-semibold text-gray-800 md:text-3xl">Method Not Allowed
                </h1>
                <p class="mt-4 text-gray-500">Oops! The request method is not supported for this page.
                </p>
