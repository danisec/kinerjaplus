<x-app-layout title="{{ $title = '429' }}">

    <section class="bg-white">
        <div class="container mx-auto flex min-h-screen items-center justify-center">
            <div>
                <p class="text-sm font-medium text-blue-600">429 Too Many Requests</p>
                <h1 class="mt-3 text-2xl font-semibold text-gray-800 md:text-3xl">Slow down!
                </h1>
                <p class="mt-4 text-gray-500">You've made too many requests in a short period. Please wait and try again
                    later.</p>
