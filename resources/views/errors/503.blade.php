<x-app-layout title="{{ $title = '503' }}">

    <section class="bg-white">
        <div class="container mx-auto flex min-h-screen items-center justify-center">
            <div>
                <p class="text-sm font-medium text-blue-600">503 Service Unavailable</p>
                <h1 class="mt-3 text-2xl font-semibold text-gray-800 md:text-3xl">Service Unavailable
                </h1>
                <p class="mt-4 text-gray-500">Our servers are currently down for maintenance. Please check back later.
                </p>
