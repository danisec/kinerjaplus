<x-app-layout title="{{ $title = '419' }}">

    <section class="bg-white">
        <div class="container mx-auto flex min-h-screen items-center justify-center">
            <div>
                <p class="text-sm font-medium text-blue-600">419 Page Expired</p>
                <h1 class="mt-3 text-2xl font-semibold text-gray-800 md:text-3xl">Page Expired
                </h1>
                <p class="mt-4 text-gray-500">Your session has expired. Please refresh the page and try again.</p>
