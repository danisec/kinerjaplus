<x-app-layout title="{{ $title = '401' }}">

    <section class="bg-white">
        <div class="container mx-auto flex min-h-screen items-center justify-center">
            <div>
                <p class="text-sm font-medium text-blue-600">401 Unauthorized</p>
                <h1 class="mt-3 text-2xl font-semibold text-gray-800 md:text-3xl">You are not authorized to access this
                    page
                </h1>
                <p class="mt-4 text-gray-500">Sorry, you need to log in or provide valid credentials to access this
                    resource.</p>
