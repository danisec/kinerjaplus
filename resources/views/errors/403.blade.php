<x-app-layout title="{{ $title = '403' }}">

    <section class="bg-white">
        <div class="container mx-auto flex min-h-screen items-center justify-center">
            <div>
                <p class="text-sm font-medium text-blue-600">403 Forbidden</p>
                <h1 class="mt-3 text-2xl font-semibold text-gray-800 md:text-3xl">Access Denied
                </h1>
                <p class="mt-4 text-gray-500">Sorry, you do not have permission to view this page.</p>
