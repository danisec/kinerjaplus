<x-app-dashboard title="{{ $title }}">
            ...
            @can('direct.permission', 'kelola subkriteria')
                <div>
                    <a href="{{ route('subkriteria.create') }}">
                        <x-atoms.button.button-primary :type="'button'" :name="'Tambah Subkriteria'" />
                    </a>
                </div>
            @endcan
        </div>
    ...
    <div
        ...
        <x-molecules.table.table :title="'Daftar Subkriteria'" :placeholderSearch="'Cari Subkriteria'" :request="request('nama_subkriteria')" :nameSearch="'nama_subkriteria'">
            <x-slot:thead>
                    ...
                    <td class="xs:gap-2.5 flex justify-center p-6 sm:gap-4">
                        ...
                        @can('direct.permission', 'kelola subkriteria')
                            ...
                            <div x-data="{ showTooltip: false, isOpen: false }">
                                ...
                                <x-molecules.modal.modal-delete :title="'Apakah Anda yakin ingin menghapus nama subkriteria: ' .
                                    $item->nama_subkriteria .
