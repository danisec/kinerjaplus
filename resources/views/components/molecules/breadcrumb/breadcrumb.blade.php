<nav class="rounded-md bg-white p-2" aria-label="Breadcrumb">
    <ol class="flex flex-row items-center gap-0.5 overflow-x-auto whitespace-nowrap">
        <li>
            <a class="hover:text-brand-500 dark:hover:text-brand-400 xs:text-xs flex items-center gap-1 text-gray-500 sm:text-sm dark:text-gray-400"
                ...
                <svg class="xs:-mt-0.5 fill-current sm:mt-0" width="16" height="16" viewBox="0 0 16 16" fill="none"
