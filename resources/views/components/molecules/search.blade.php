...
<form method="GET">
    <div class="relative h-auto w-96">
        ...
        <input
            class="block w-full rounded-lg border border-slate-200 bg-slate-100 p-3.5 pl-9 pr-20 text-base text-gray-900 focus:border-indigo-600 focus:ring-indigo-600"
